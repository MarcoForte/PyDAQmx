...
DAQmxResetDevice(b'dev1')

taskHandle=TaskHandle()
DAQmxCreateTask(b"",byref(taskHandle))
DAQmxCreateAIVoltageChan(taskHandle,b"Dev1/ai0",b"",DAQmx_Val_RSE,-10.0,10.0,DAQmx_Val_Volts,None)
DAQmxCfgSampClkTiming(taskHandle,b"",10000.0,DAQmx_Val_Rising,DAQmx_Val_ContSamps,1000)
